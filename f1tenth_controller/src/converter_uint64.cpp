...
public:
    ...
    void subCallback(const std_msgs::UInt64::ConstPtr& msg_sub);
    void pubCallback();
    void convert_value();
};

void Converter::subCallback(const std_msgs::UInt64::ConstPtr& msg_sub)
{
    this->servo_data = (int)msg_sub->data;
    this->convert_value();
    this->pubCallback();
}
